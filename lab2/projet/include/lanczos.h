...
extern inline double ProdScal(const double * u, const double * v, uint taille);
...
extern inline double * ProdMatVectDiff(const double ** A, const double * X,const double alpha,const double * Y,double * R,uint nrowA, uint ncolA, uint sizeX, uint sizeY,uint sizeR);
